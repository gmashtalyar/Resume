...
txt('**Бизнес аналитик |**  [Ариэль Металл](https://arielmetal.ru)', '2021-2022')
st.markdown('''
...
- Построение модели управления закупками, складскими запасами и продажами, автоматизаия и синхронизация с помошью `Python`.
...
txt('**Финансовый консультант**', '2016-2022')
st.markdown('''
